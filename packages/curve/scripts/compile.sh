...
for f in counter.json counter.scrypt locks.json linearCurvePool.json linearCurvePool.scrypt curve-locks.json ledgerPool.json ledgerPool.scrypt stasCurvePool.json stasCurvePool.scrypt; do
